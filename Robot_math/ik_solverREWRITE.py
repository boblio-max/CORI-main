...
class IKSolver:
    ...
    def solve_vectors(self, fx, fy, fz):
        ...
        # The distance from the base to the end effector is calculated, and if it's greater than the maximum reach of the arm        dist = np.hypot(r, s)
        max_reach = self.L * 3
        dist = np.hypot(r, s)
    ...
    # Calls the solve_vectors function by inputting the desired position of the end effector as separate values
